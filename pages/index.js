...
//-- Отлавливаем клик мышки на области с карточками--//
places.addEventListener('click', (evt) => {
  //-- Удаляем карточку если клин на корзинке--//
  if (evt.target.className === 'button button_target_delete') {
    evt.target.parentElement.remove();
  }
  //-- Ставим лайк или дизлайк если клик на сердечке--//
  ...
  //-- Открываем попап с картинкой если клин на картинке--//
